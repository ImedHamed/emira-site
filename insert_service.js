...
const db = new Database(path.join(__dirname, 'server', 'emira.db'))
...
if (existing) {
    ...
    insertFeature.run(13, 'Analyseur Chauvin Arnoux CA8336', 'Chauvin Arnoux CA8336 analyzer', 0)
    insertFeature.run(13, 'Analyse qualité réseau', 'Network quality analysis', 1)
    insertFeature.run(13, 'Mesure des harmoniques', 'Harmonics measurement', 2)
    insertFeature.run(13, "Rapport d'étude détaillé", 'Detailed study report', 3)
